...
#undef RSAZ_ENABLED
/*
 * MINIX clang 3.6 can't assemble the AVX-2/AVX-512 .S sources that
 * provide the ossl_rsaz_* helpers; skip the whole RSAZ fast-path.
 */
#if !defined(__minix) && defined(OPENSSL_BN_ASM_MONT) && (defined(__x86_64) || defined(__x86_64__) || defined(_M_AMD64) || defined(_M_X64))
#define RSAZ_ENABLED
