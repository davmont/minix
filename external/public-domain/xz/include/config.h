...
#if !defined(__minix)
/* Define to 1 when using POSIX threads (pthreads).  MINIX libc has no
 * pthread implementation; leaving this undefined makes mythread.h fall
 * back to its no-thread stubs (mythread.h:18-22) and the lib/Makefile
 * excludes the multi-threaded encoder modules. */
