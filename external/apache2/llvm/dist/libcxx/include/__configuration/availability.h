...
// MINIX: its libcxxrt predates __cxa_init_primary_exception, so force the
// throw-based make_exception_ptr fallback.
#if !_LIBCPP_HAS_EXCEPTIONS || !_LIBCPP_HAS_RTTI || defined(__minix)
