...
/* MINIX: libctf's mmap CTF-archive path calls msync(), which MINIX libc does
   not provide (msync is in MISSING_SYSCALLS).  Force the read/write fallback
   in ctf-archive.c by leaving HAVE_MMAP undefined. */
/* #undef HAVE_MMAP */
