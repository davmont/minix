...
#if !defined(__minix)
/* Define to 1 if you have a working `mmap' system call.  MINIX lacks
 * both mmap and mprotect in libc; leaving this undefined makes file.h
 * (line 685) not auto-define QUICK, so apprentice.c uses the
 * malloc+read fallback for magic-db loading. */
#define HAVE_MMAP 1
