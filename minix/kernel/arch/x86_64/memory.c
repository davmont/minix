...
/* video_mem: paged-kernel VGA pointer, initialised to physical VGA buffer.
 * Updated to the virtual address by arch_phys_map_reply() after VM setup.
 * The unpaged early-boot copy lives in pre_init.c as __k_unpaged_video_mem. */
